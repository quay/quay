...
CREATE TABLE IF NOT EXISTS "blobupload" (
	...
	created DATETIME DEFAULT '2026-07-08 19:15:18' NOT NULL,
...
CREATE TABLE IF NOT EXISTS "oauthaccesstoken" (
	...
	data TEXT NOT NULL,
	token_code VARCHAR(255) NOT NULL,
	token_name VARCHAR(255) NOT NULL, last_accessed DATETIME, created DATETIME,
...
CREATE TABLE manifestsecuritystatus (
	...
	metadata_json TEXT NOT NULL, error_count INTEGER DEFAULT '0' NOT NULL,
...
CREATE UNIQUE INDEX user_email_unique_non_org ON "user"(email) WHERE organization = false;
CREATE INDEX user_email_idx ON user (email);
CREATE INDEX oauthaccesstoken_application_id_last_accessed ON oauthaccesstoken (application_id, last_accessed);
