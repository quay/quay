-- Enum/lookup seed rows for the OMR v2 baseline at revision 3f8d7acdf7f9.
-- Independently verified against the same fresh `alembic upgrade
-- 3f8d7acdf7f9` SQLite run documented in 3f8d7acdf7f9_schema.sql. Contains
-- only the alembic_version row and Alembic-created static lookup content --
-- no install or runtime-created data. Source lookup rows replace these
-- baseline values during PostgreSQL conversion.
