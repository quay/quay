...
class SecurityScanningNotificationWorker(QueueWorker):
    ...
    def _perform_notification_worker(self, job_details):
        ...
        while True:
            page_result = secscan_model.lookup_notification_page(notification_id, page_index)
            ...
            with notification_batch() as spawn_notification:
                ...
                for updated_vuln_info in secscan_model.process_notification_page(page_result.data):
            ...
            if page_index is None:
                ...
                attempt_count = 5
                while not secscan_model.mark_notification_handled(notification_id):
                    attempt_count -= 1
                    if attempt_count == 0:
                        break
