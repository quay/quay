...
EXTERNAL_JS = [
    ...
    "ajax.googleapis.com/ajax/libs/angularjs/1.6.4/angular-route.min.js",
    "ajax.googleapis.com/ajax/libs/angularjs/1.6.4/angular-sanitize.min.js",
    "ajax.googleapis.com/ajax/libs/angularjs/1.6.4/angular-animate.min.js",
    "ajax.googleapis.com/ajax/libs/angularjs/1.6.4/angular-cookies.min.js",
