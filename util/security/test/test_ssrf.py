# -*- coding: utf-8 -*-
"""
Unit tests for URL validation in util/security/ssrf.py.
"""
...
class TestValidateExternalRegistryUrl:
    ...
    def test_dns_resolving_to_metadata_ip_rejected(self):
        with patch("util.security.ssrf._getaddrinfo") as mock_dns:
            mock_dns.return_value = [
                (2, 1, 6, "", ("169.254.169.254", 0)),
            ]
            with pytest.raises(SSRFBlockedError, match="private or reserved"):
                validate_external_registry_url("https://evil-metadata.example.com")
...
class TestAllowlist:
    """Tests for allowed_hosts allowlist functionality."""
