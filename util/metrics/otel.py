...
def init_exporter(app_config):
    ...
    if otel_headers == {}:
        ...
        otel_headers = os.environ.get(
            ...
            os.environ.get("OTEL_EXPORTER_OTLP_TRACES_HEADERS", otel_headers),
        )
    otel_endpoint = otel_config.get(
        "OTEL_EXPORTER_OTLP_ENDPOINT",
        otel_config.get("OTEL_EXPORTER_OTLP_TRACES_ENDPOINT", "http://127.0.0.1"),
    )
    if otel_endpoint == "http://127.0.0.1":
        # accept Environ overwrites
