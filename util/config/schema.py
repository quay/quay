...
INTERNAL_ONLY_PROPERTIES = {
    ...
    "ORG_MIRROR_RETRY_INTERVAL",
    "ORG_MIRROR_REPO_CREATION_RATE_LIMIT",
    "ORG_MIRROR_REPO_CREATION_BATCH_SIZE",
...
CONFIG_SCHEMA = {
    ...
    "properties": {
        ...
        "FEATURE_ORG_MIRROR": {
            "type": "boolean",
            "description": "Whether to enable organization-level repository mirroring. Defaults to True",
            "x-example": True,
        },
        "ORG_MIRROR_INTERVAL": {
            "type": "number",
            "description": "The number of seconds between checking for organization mirror candidates. Defaults to 30.",
            "minimum": 10,
            "x-example": 30,
        },
        "ORG_MIRROR_BATCH_SIZE": {
            "type": "number",
            "description": "The maximum number of organization mirrors to process per worker iteration. Defaults to 100.",
            "minimum": 1,
            "x-example": 100,
        },
        "ORG_MIRROR_MAX_SYNC_DURATION": {
            "type": "number",
            "description": "The maximum duration in seconds for a single organization mirror sync operation. Defaults to 3600 (1 hour).",
            "minimum": 60,
            "x-example": 3600,
        },
        "ORG_MIRROR_DEFAULT_SKOPEO_TIMEOUT": {
            "type": "number",
            "description": "The default timeout in seconds for skopeo operations during organization mirroring. Defaults to 300 (5 minutes).",
            "minimum": 30,
            "x-example": 300,
        },
        "ORG_MIRROR_DISCOVERY_TIMEOUT": {
            "type": "number",
            "description": "The timeout in seconds for discovering repositories from external registries. Defaults to 600 (10 minutes).",
            "minimum": 60,
            "x-example": 600,
        },
        "ORG_MIRROR_MAX_REPOS_PER_ORG": {
            "type": "number",
            "description": "The maximum number of repositories that can be discovered per organization (safety limit). Defaults to 10000.",
            "minimum": 1,
            "x-example": 10000,
        },
        "ORG_MIRROR_MAX_RETRIES": {
            "type": "number",
            "description": "The maximum number of retry attempts for failed organization mirror syncs. Defaults to 3.",
            "minimum": 0,
            "x-example": 3,
        },
        "ORG_MIRROR_RETRY_INTERVAL": {
            "type": "number",
            "description": "The interval in seconds between retry attempts for failed syncs. Defaults to 300 (5 minutes).",
            "minimum": 60,
            "x-example": 300,
        },
        "ORG_MIRROR_REPO_CREATION_RATE_LIMIT": {
            "type": "number",
            "description": "The maximum number of repositories to create per worker iteration (rate limiting). Defaults to 10.",
            "minimum": 1,
            "x-example": 10,
        },
        "ORG_MIRROR_REPO_CREATION_BATCH_SIZE": {
            "type": "number",
            "description": "The number of repositories to create in each batch during organization mirroring. Defaults to 5.",
            "minimum": 1,
            "x-example": 5,
        },
        # Build
