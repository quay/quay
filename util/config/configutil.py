...
def add_enterprise_config_defaults(config_obj, current_secret_key):
    ...
    config_obj["FEATURE_ORG_MIRROR"] = config_obj.get("FEATURE_ORG_MIRROR", False)
    config_obj["FEATURE_RESTRICTED_V2_SCHEMA1_PUSH"] = config_obj.get(
        "FEATURE_RESTRICTED_V2_SCHEMA1_PUSH", False
    )
