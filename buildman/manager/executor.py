        ...
        rendered_json = json.load(
            io.StringIO(
                TEMPLATE.render(
                    ...
                    http_proxy=self.executor_config.get("HTTP_PROXY", False),
                    https_proxy=self.executor_config.get("HTTPS_PROXY", False),
                    noproxy=self.executor_config.get("NO_PROXY", False),
                )
            )
        )
