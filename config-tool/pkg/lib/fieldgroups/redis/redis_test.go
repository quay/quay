...
func TestValidateRedis(t *testing.T) {
	...
	var tests = []struct {
		...
		{name: "Works", config: map[string]interface{}{"BUILDLOGS_REDIS": map[string]interface{}{"host": "redis", "port": 6379}, "USER_EVENTS_REDIS": map[string]interface{}{"host": "redis", "port": 6379}, "PULL_METRICS_REDIS": map[string]interface{}{"host": "redis", "port": 6379, "db": 1}}, want: "valid"},
	}
