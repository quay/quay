FROM registry.access.redhat.com/ubi9/python-312-minimal:latest@sha256:fe0b4d46e769a01ed0b7849eca019a03bf4dab21bc037bb9529ee1d1ed04e0d8 AS base
...
FROM registry.access.redhat.com/ubi9/ubi-minimal:latest@sha256:1bc3c5c15720506a0cf48adfdf8b623dfe704377e007d7bbae8d14876392ca6a AS pushgateway
ENV OS=linux
...
FROM registry.access.redhat.com/ubi9/go-toolset@sha256:430cd439ea3bb4af3727a843c0302594bb1973211ecbfc98e4450a40798075df AS config-tool
WORKDIR /opt/app-root/src
COPY config-tool/ ./
ENV GOTOOLCHAIN=auto
RUN GOPATH=/opt/app-root/src/go GOFIPS140=latest go install -tags=fips ./cmd/config-tool

FROM registry.access.redhat.com/ubi9/ubi-minimal@sha256:1bc3c5c15720506a0cf48adfdf8b623dfe704377e007d7bbae8d14876392ca6a AS build-quaydir
WORKDIR /quaydir
