...
class BaseRegistryMixin(object):
  def conduct(self, method, url, headers=None, data=None, auth=None, params=None, expected_code=200,
    ...
    return self._conduct(method, url, headers, data, auth, params, expected_code,
                         json_data, user_agent, csrf_token=csrf_token)

  def _conduct(self, method, url, headers=None, data=None, auth=None, params=None, expected_code=200,
               json_data=None, user_agent=None, csrf_token=None):
    params = params or {}
    if csrf_token:
