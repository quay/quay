...
organization. Permissions are granted through normal Quay mechanisms (org
membership, team roles) — not superuser.
"""
...
class KubernetesServiceAccountLoginService(OIDCLoginService):
    ...
    def __init__(
        ...
        self._allowed_subjects: list[str] = kubernetes_config.get("ALLOWED_SUBJECTS") or []
    ...
    def allowed_subjects(self) -> list[str]:
        """List of SA subjects allowed to authenticate."""
    ...
    def is_allowed_subject(self, subject: str) -> bool:
        """Check if the given SA subject is allowed to authenticate."""
        return subject in self._allowed_subjects
