...
test.describe('Logout functionality', {tag: ['@auth', '@critical']}, () => {
  test('logs out successfully', async ({logoutPage}) => {
    ...
    await expect(logoutPage.locator('#user-menu-toggle')).toBeVisible();

    // Click user menu
    await logoutPage.locator('#user-menu-toggle').click();
  ...
  test('logout menu item has danger styling', async ({authenticatedPage}) => {
    ...
    await expect(authenticatedPage.locator('#user-menu-toggle')).toBeVisible();

    // Click user menu
    await authenticatedPage.locator('#user-menu-toggle').click();
