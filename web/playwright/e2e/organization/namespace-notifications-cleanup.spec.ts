...
test.describe(
  ...
  () => {
    test(
      ...
      {tag: '@superuser'},
      async ({authenticatedPage, api, superuserApi}) => {
    ...
    test(
      'deleting a quota limit does NOT remove notification configs',
      {tag: '@superuser'},
      async ({authenticatedPage, api, superuserApi}) => {
    ...
    test(
      're-creating quota after deletion starts fresh — notifications can be reconfigured',
      {tag: '@superuser'},
      async ({authenticatedPage, api, superuserApi}) => {
