...
test.describe('Service Key Approve', {tag: ['@api', '@auth:Database']}, () => {
  test(
    'superuser can create and approve a service key',
    {tag: '@superuser'},
...
test.describe('Take Ownership', {tag: ['@api', '@auth:Database']}, () => {
  test(
    'superuser can take ownership of an organization',
    {tag: '@superuser'},
    async ({superuserApi, adminClient}) => {
...
test.describe('Create Install User', {tag: ['@api', '@auth:Database']}, () => {
  test(
    'superuser can create a user via superuser API and get generated password',
    {tag: '@superuser'},
    async ({superuserApi}) => {
...
test.describe(
  ...
  () => {
    test(
      'superuser can restore a tag to a previous manifest digest',
      {tag: '@superuser'},
      async ({superuserApi, adminClient}) => {
    ...
    test(
      'superuser can create a new tag pointing to existing manifest',
      {tag: '@superuser'},
      async ({superuserApi, adminClient}) => {
...
test.describe('Prototypes Full CRUD', {tag: ['@api', '@auth:Database']}, () => {
  test(
    'superuser can create, list, update, and delete a permission prototype',
    {tag: '@superuser'},
    async ({superuserApi, adminClient}) => {
...
test.describe('Export Action Logs', {tag: ['@api', '@auth:Database']}, () => {
  test(
    'superuser can export repository logs',
    {tag: '@superuser'},
    async ({superuserApi, adminClient}) => {
  ...
  test(
    'superuser can export organization logs',
    {tag: '@superuser'},
    async ({superuserApi, adminClient}) => {
...
test.describe(
  ...
  () => {
    test(
      'superuser can read repository aggregate logs',
      {tag: '@superuser'},
      async ({superuserApi, adminClient}) => {
    ...
    test(
      'superuser can read organization aggregate logs',
      {tag: '@superuser'},
      async ({superuserApi, adminClient}) => {
