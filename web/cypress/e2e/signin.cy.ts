...
describe('Forgot Password functionality', () => {
  ...
  it('Switches to forgot password view', () => {
    ...
    cy.contains('Please enter the e-mail address for your account').should('be.visible');
  ...
  it('Sends recovery email successfully', () => {
    ...
    cy.contains('Instructions on how to reset your password have been sent').should('be.visible');
  });
