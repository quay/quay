      ...
      cy.get('li').each(($el, index) => {
        switch (index) {
          case 0:
            ...
            cy.wrap($el).children('a').should("have.attr", "href", "/organization");
            break;
          case 1:
            cy.wrap($el).should("have.text", "projectquay");
            cy.wrap($el).children('a').should("have.class", "disabled-link");
            cy.wrap($el).children('a').should("have.attr", "href", "/organization/projectquay");
            break;
        }
      })
        .then(($lis) => {
      ...
      cy.get('li').each(($el, index) => {
        switch (index) {
          case 0:
            ...
            cy.wrap($el).children('a').should("have.attr", "href", "/repository");
            break;
          case 1:
            cy.wrap($el).should("have.text", "projectquay");
            cy.wrap($el).children('a').should("have.attr", "href", "/organization/projectquay");
          ...
          case 2:
            ...
            cy.wrap($el).children('a').should("have.class", "disabled-link");
            cy.wrap($el).children('a').should("have.attr", "href", "/repository/projectquay/repo1");
            break;
        }
      })
        .then(($lis) => {
      ...
      cy.get('li').each(($el, index) => {
        switch (index) {
          ...
          case 1:
            ...
            cy.wrap($el).children('a').should("have.attr", "href", "/organization/user1");
            break;
          case 2:
            cy.wrap($el).should("have.text", "hello-world");
            cy.wrap($el).children('a').should("have.attr", "href", "/repository/user1/hello-world");
            break;
          case 3:
            cy.wrap($el).should("have.text", "latest");
            cy.wrap($el).children('a').should("have.class", "disabled-link");
            cy.wrap($el).children('a').should("have.attr", "href", "/repository/user1/hello-world/tag/latest");
            break;
        }
      })
        .then(($lis) => {
