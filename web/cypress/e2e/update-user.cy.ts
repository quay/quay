...
describe('Update User Component', () => {
  ...
  it('successfully confirms username', () => {
    ...
    cy.intercept('GET', '/api/v1/users/*', {statusCode: 404, body: {username: 'user1'}}).as('validateUsername');
    cy.intercept('GET', '/api/v1/organization/user1', {statusCode: 404}).as('validateOrg');
