...
import { useCreateRepositoryAutoPrunePolicy, useDeleteRepositoryAutoPrunePolicy, useFetchRepositoryAutoPrunePolicies, useUpdateRepositoryAutoPrunePolicy } from 'src/hooks/UseRepositoryAutoPrunePolicies';
...
import { shorthandTimeUnits } from 'src/routes/OrganizationsList/Organization/Tabs/Settings/AutoPruning';
  ...
  export default function RepositoryAutoPruning(props: RepositoryAutoPruning) {
    ...
    const {
      ...
      repoPolicies,
      dataUpdatedAt,
    } = useFetchRepositoryAutoPrunePolicies(props.organizationName, props.repoName);
    ...
    } = useCreateRepositoryAutoPrunePolicy(props.organizationName,props.repoName);
    ...
    } = useUpdateRepositoryAutoPrunePolicy(props.organizationName, props.repoName);
    ...
    } = useDeleteRepositoryAutoPrunePolicy(props.organizationName, props.repoName);
    ...
    }, [successFetchingRepoPolicies, dataUpdatedAt]);
