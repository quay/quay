        ...
        <DataList aria-label="Key features">
          <DataListItem>
            <ExpandableSection
              ...
              displaySize="lg"
            >
              <Content component="p" id="store-containers-info">
          ...
          <DataListItem>
            <ExpandableSection
              ...
              displaySize="lg"
            >
              <Content component="p" id="build-containers-info">
          ...
          <DataListItem>
            <ExpandableSection
              ...
              displaySize="lg"
            >
              <Content component="p" id="scan-containers-info">
          ...
          <DataListItem>
            <ExpandableSection
              ...
              displaySize="lg"
            >
              <Content component="p" id="public-containers-info">
                {
