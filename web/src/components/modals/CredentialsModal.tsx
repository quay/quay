      ...
      <ModalBody>
        {isNewlyCreated && isToken && (
          ...
          >
            ...
            your password for Docker and other CLI commands. Make sure to copy
        ...
        {!isNewlyCreated && isToken && (
          <Alert
            ...
            className="pf-v6-u-mb-md"
          >
            This token can be used in place of your password for Docker and
            other CLI commands. Keep it secure and do not share it.
          </Alert>
        )}
        {!isToken && (
          <Alert
            ...
            className="pf-v6-u-mb-md"
          >
            This encrypted password can be used for <code>docker login</code>{' '}
            and other CLI commands. It is recommended to use this instead of
        ...
        >
          <Tab
            eventKey={0}
            title={<TabTitleText>{firstTabTitle}</TabTitleText>}
          >
