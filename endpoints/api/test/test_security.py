...
SECURITY_TESTS: List[
    ...
    (NamespaceQuotaList, "GET", {"namespace": "buynlarge"}, None, "devtable", 200),
    (NamespaceQuotaList, "GET", {"namespace": "buynlarge"}, None, "randomuser", 403),
    (NamespaceQuotaList, "GET", {"namespace": "buynlarge"}, None, None, 401),
    (NamespaceQuotaList, "POST", {"namespace": "buynlarge"}, {"limit_bytes": 200000}, None, 401),
    (
        NamespaceQuotaList,
        "POST",
        {"namespace": "buynlarge"},
    ...
    (NamespaceQuotaList, "GET", {"namespace": "randomuser"}, None, "devtable", 200),
    (NamespaceQuotaList, "GET", {"namespace": "randomuser"}, None, "freshuser", 403),
    (NamespaceQuotaList, "GET", {"namespace": "randomuser"}, None, None, 401),
    (NamespaceQuotaList, "POST", {"namespace": "randomuser"}, {"limit_bytes": 200000}, None, 401),
    (
        NamespaceQuotaList,
        "POST",
