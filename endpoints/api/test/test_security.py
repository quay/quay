...
SECURITY_TESTS: List[
    ...
    (DumpConfig, "GET", BUILD_PARAMS, None, None, 401),
    (DumpConfig, "GET", BUILD_PARAMS, None, "freshuser", 403),
    (DumpConfig, "GET", BUILD_PARAMS, None, "reader", 403),
    (DumpConfig, "GET", BUILD_PARAMS, None, "devtable", 404),
    (DumpConfig, "GET", BUILD_PARAMS, None, "globalreadonlysuperuser", 200),
