...
SECURITY_TESTS: List[
    ...
    (SuperUserRepositoryList, "GET", {"namespace": "devtable"}, None, None, 401),
    (SuperUserRepositoryList, "GET", {"namespace": "devtable"}, None, "devtable", 200),
    (SuperUserRepositoryList, "GET", {"namespace": "devtable"}, None, "freshuser", 403),
    (SuperUserRepositoryList, "GET", {"namespace": "devtable"}, None, "reader", 403),
