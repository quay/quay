...
def _mock_dns_for_ssrf_validation():
    """
    Mock DNS resolution in the SSRF validation module so tests with
...
@pytest.mark.usefixtures("_mock_dns_for_ssrf_validation")
class TestExportLogsSSRFProtection:
    """Tests for SSRF protection in export logs callback URLs."""
